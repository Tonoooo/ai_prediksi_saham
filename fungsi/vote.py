...
# ~~~~~ !!! INI KHUSUS UNTUK PROGRAM main.ipynb dan superior.ipynb
#   Funsi fungsi ini untuk mengambil pemungutan suara dari kelas kelas model itu

import pandas as pd

def peringkat_50(hasil_k1,hasil_k2,hasil_k3,hasil_k4,hasil_k5,
    ...
    try:
        k1_50b = hasil_k1[0:50][['Saham','Perubahan(%)']]
        k2_50b = hasil_k2[0:50][['Saham','Perubahan(%)']]
        k3_50b = hasil_k3[0:50][['Saham','Perubahan(%)']]
        k4_50b = hasil_k4[0:50][['Saham','Perubahan(%)']]
        k5_50b = hasil_k5[0:50][['Saham','Perubahan(%)']]
        k6_50b = hasil_k6[0:50][['Saham','Perubahan(%)']]
        k7_50b = hasil_k7[0:50][['Saham','Perubahan(%)']]
        k8_50b = hasil_k8[0:50][['Saham','Perubahan(%)']]
        k9_50b = hasil_k9[0:50][['Saham','Perubahan(%)']]
        k10_50b = hasil_k10[0:50][['Saham','Perubahan(%)']]
        k11_50b = hasil_k11[0:50][['Saham','Perubahan(%)']]
        k12_50b = hasil_k12[0:50][['Saham','Perubahan(%)']]
        k13_50b = hasil_k13[0:50][['Saham','Perubahan(%)']]
        k14_50b = hasil_k14[0:50][['Saham','Perubahan(%)']]
        k15_50b = hasil_k15[0:50][['Saham','Perubahan(%)']]
        k16_50b = hasil_k16[0:50][['Saham','Perubahan(%)']]
        k17_50b = hasil_k17[0:50][['Saham','Perubahan(%)']]
        k18_50b = hasil_k18[0:50][['Saham','Perubahan(%)']]
        k19_50b = hasil_k19[0:50][['Saham','Perubahan(%)']]
        k20_50b = hasil_k20[0:50][['Saham','Perubahan(%)']]
        k21_50b = hasil_k21[0:50][['Saham','Perubahan(%)']]
        # gabungkan semua df itu
        p50b = pd.concat([k1_50b,k2_50b,k3_50b,k4_50b,k5_50b,k6_50b,k7_50b,k8_50b,k9_50b,k10_50b,
                         k11_50b,k12_50b,k13_50b,k14_50b,k15_50b,k16_50b,k17_50b,k18_50b,k19_50b,k20_50b,k21_50b],
                         keys=['k1_50b','k2_50b','k3_50b','k4_50b','k5_50b','k6_50b','k7_50b','k8_50b','k9_50b','k10_50b',
                              'k11_50b','k12_50b','k13_50b','k14_50b','k15_50b','k16_50b','k17_50b','k18_50b','k19_50b','k20_50b','k21_50b'])
        p50b_list = p50b['Saham'].tolist() # kolom saham jadikan sebuah list
        # ambil voting dari p50b_list
        vote_50b = pd.Series(p50b_list).value_counts() # pd series yang berisi saham dan banyak voting
        # jadikan vote_50b menjadi dataframe. ini untuk menyaring saham
        my_count_df = pd.DataFrame(vote_50b)# pd series tadi jadikan dataframe
        ...
        df_peringkat_50besar = pd.DataFrame(columns=['Saham','voting','total jumlah persentase(%)'])
        # for loop untuk mengisi dataframe df_peringkat_50besar
        for i in range(len(my_count_df)):
            # ambil key/kunci teratas(ticker saham yang paling banyak mendapatkan vote) di pandasSeries
            juara_50b = vote_50b.keys()[i] # mendapatkan key/kunci(ticker saham) di pandasSeries
            # ambil berapa banyak yang ngevote juara_50b
            juara_50bv = vote_50b[i] # mendapatkan nilai(banyak yang ngevote disuatu saham) pertama di pd.Series
            baris_50b=p50b[p50b.isin([juara_50b]).any(axis=1)] # mendapatkan semua baris yang memiliki nilai juara_50b
            totaljumlah_persen = baris_50b['Perubahan(%)'].sum() # menjumlahkan seluruh persentase si juara_50b
            # memasukkan ke dalam dataframe
            df_peringkat_50besar = pd.concat([df_peringkat_50besar, pd.DataFrame.from_records([{
                        'Saham':juara_50b, 'voting':juara_50bv,'total jumlah persentase(%)':totaljumlah_persen}])])
        # rapihkan dataframe
        # mengurutkan sesuai dengan banyak voting
        df_peringkat_50besar.sort_values(by='voting',ascending=False,inplace=True)
        df_peringkat_50besar.reset_index(inplace=True, drop=True)
        # mendapatkan kolom saham lalu jadikan list
        list_50b = df_peringkat_50besar['Saham'].tolist()
        return df_peringkat_50besar, list_50b
    except:
        print('!!! ---> Diperingkat 50 besar tidak ada yang sama')
